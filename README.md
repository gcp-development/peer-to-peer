...
<ul>
 ...
 <li>A register service that are is able store SHA256(PeerID) in a data structure.<a href="https://docs.ipfs.tech/concepts/dht/#kademlia">Kademlia Distributed Hash Table.</a></li>
</ul>
